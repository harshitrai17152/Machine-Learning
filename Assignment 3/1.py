...
class Neural_Net:
  ...
  def backward(self,X,Y,out):
    ...
    for i in range(t-1,0,-1):
      ...
      self.del_w[i]=np.matmul(self.y_j[i-1].T,yk)    
      yk=np.matmul(yk,self.W[i].T)
    ...
    self.del_w[i-1]=np.matmul(X.T,yk)
